...
function Home(props) {
  ...
  const onChange = (e) => {
    ...
    setValueOfXHealth(
      isNaN(value) === true ? 0.0 : (value / xHealthPrice).toFixed(3)
    );
  ...
  return (
    <div>
        ...
        <nav className="navbar navbar-expand-lg navbar-light">
          <div className="container-fluid alignment">
            <a className="navbar-brand" href="/">
              <div>
              <img class="logoImg" src="images/avalanche-avax-logo.png" alt="gfgf" />
              </div>
            </a>
          </div>
        </nav>
          ...
          <div className="container-fluid alignment">
            <div className="row align-items-center">
              <div className="col-xl-6 col-md-12">
                <h1>Avalanche Initial Coin Offering.</h1>
                <p>
                  {" "}
                ...
                <div className="hero-btns d-flex align-items-center">
                  <a href="/" className="m-btn btn--primary">
                    WHITEPAPER
                  </a>
                  <button
                    className="m-btn btn--primary"
                    onClick={() => (input_ref.current.value = "")}
                    data-bs-toggle="modal"
                    data-bs-target="#xHEALTHModal"
                  >
                    Get $ICOtoken
                  </button>
                </div>
      ...
      {/* Modal */}
      <div
        className="modal fade modal-xHEALTH"
        id="xHEALTHModal"
        tabindex="-1"
        aria-labelledby="xHEALTHModalLabel"
        aria-hidden="true"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="xHEALTHModalLabel">
                BUY ICOtoken with USDC
              </h5>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="modal-body">
              ...
              <div className="modal-input-from-main modal-input-to-main">
                <div className="modal-input-left-txt">{valueOfXHealth}</div>
                <div className="modal-input-right-txt">
                  <img
                    src="images/to-input-ic.png"
                    className="img-fluid"
                    alt=""
                  />
                  ICOtoken
              ...
              <div className="modal-bottom-input-txt">
                ...
                <h6 className="dark-font">10 USDC per ICOtoken</h6>
              </div>
            </div>
